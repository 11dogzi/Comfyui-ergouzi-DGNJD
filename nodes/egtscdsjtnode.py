...
class EGTSCDSJTLNode:
    ...
    CATEGORY_KEYS = ['视角', '摆位', '动作', '构图方式', '人物镜头', '镜头', '相机镜头']
    ...
    def get_input_types_from_keys(keys):
        input_types = {}
        for key in keys:
            input_types[key] = (tuple(EGTSCDSJTLNode.get_options_keys(key)), {"default": "无"})
...
NODE_DISPLAY_NAME_MAPPINGS = { "EG_TSCDS_JT" : "2🐕提示词大师镜头类" }
